...
extension UIImage {
    ...
    func resizedImage(newSize:CGSize, transform:CGAffineTransform, drawTransposed transpose:Bool, interpolationQuality quality:CGInterpolationQuality
        ) -> UIImage {
            ...
            let bitmap:CGContextRef = CGBitmapContextCreate(
                ...
                0,
                CGImageGetColorSpace(imageRef), bitmapInfo.rawValue)!
